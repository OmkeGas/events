...
function renderSidebar() {
    ...
    // Terminator kanggo highlight sidebar seng user kunjungi
    $eventClass = ($current === 'index.php') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-gray-100';
    $userClass  = ($current === 'users.php') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-gray-100';
...
// Fungsi deteksi url webset gae highlight sidebar

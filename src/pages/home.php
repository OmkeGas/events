      ...
      <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-3">
        ...
        <div class="hidden w-full items-center justify-between gap-8 md:flex md:w-auto" id="navbar-search">
          ...
          <ul
            ...
            <li>
              <a href="#" class="block rounded-sm bg-blue-500 px-3 py-2 text-white md:bg-transparent md:p-0 md:text-blue-600" aria-current="page">Home</a>
            </li>
            <li>
              <a href="#" class="block rounded-sm px-3 py-2 text-white hover:bg-blue-500 md:p-0 md:hover:bg-transparent md:hover:text-blue-700">Event</a>
            </li>
            <li>
              <a
